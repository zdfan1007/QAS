<%@ page 
  language="java" 
  import="java.sql.*,java.io.*,java.util.*,com.ansj.vec.Word2VEC,org.ansj.app.keyword.*,com.cn.bysj.jdbc.*,com.cn.bysj.training.*" 
...
<%  
    ...
    String sql1 = "insert into question_history(question,date,userEmail,status) values(?,?,?,?)";
    String question=request.getParameter("question");  //和inputquestion.jsp中input标签里面的name名一致
    
    java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    java.util.Date currentTime = new java.util.Date();//得到当前系统时间
    String email = (String) session.getAttribute("4");
    
    int result = DbOperate.update(sql1, question, currentTime, email,1);
...
<div class="out">
    ...
    <div style="text-align:center;clear:both;padding:20px">
    	<p><a href="inputquestion" target="_self"> 返 回</a></p>
	</div>
</div>
</body>  
</html> 
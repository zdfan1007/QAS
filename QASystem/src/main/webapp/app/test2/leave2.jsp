...
<tr>
   ...
   <td align="center">
<font face="华文行楷"><span class="STYLE1">考勤管理系统员工请假信息</span>
</font></td>                
</tr>
...
out.print("<td>" + rs.getString("l_reason") + "</td>");  
out.print("<td> " + rs.getString("l_start_time")+ "</td>");
out.print("<td> " + rs.getString("l_end_time")+ "</td>");
out.print("<td> " + rs.getString("l_total_time")+ "</td>");
       }     		
rs.close();        stmt.close();            }    

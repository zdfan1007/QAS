...
<table width="80%" border="0" align="center">
  <tr>
    <td><hr />
        <form name="form1" method="post" action="doChangePSW.jsp">
          <table width="330" border="1" align="center" bordercolor="#5A92E7">
            <tr>
              <td align="center"><span class="STYLE6">旧密码</span></td>
              <td align="center"><label>
                <input name="textfield1" type="password" id="textfield1" size="25">
              </label></td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p align="center"><span class="STYLE6"><a href="<%=session.getValue("type")%>.jsp">返回 》》</a></a></span></p>
        <hr /></td>
  </tr>
</table>
</body>

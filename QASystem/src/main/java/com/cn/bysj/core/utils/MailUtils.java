...
public class MailUtils {
	...
	//--------------参数---------------------
    public static final String FROM = "2251555744@qq.com";//发件人的email
    public static final String PWD = "";//发件人密码--邮箱密码
    public static final String URL = "http://localhost:8080/index/login";//项目主页
    public static final int TIMELIMIT = 1000*60*60*24; //激活邮件过期时间24小时
    public static final String TITLE = "QAS账户激活邮件";
...
//---------------自定义函数-----------------
    public static Person sendMail(Person u) throws AddressException, MessagingException, NoSuchAlgorithmException {
        ...
        //发送的邮箱内容
        String content = "<p>您好 O(∩_∩)O~~<br><br>欢迎加入QAS!<br><br>帐户需要激活才能使用，赶紧激活成为QAS正式的一员吧:)<br><br>请在24小时内点击下面的链接立即激活帐户："
